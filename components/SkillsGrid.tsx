...
import { FaPython, FaDatabase, FaEye, FaCode, FaKeyboard, FaBrain, FaGithub, FaFileExcel, FaRobot } from 'react-icons/fa';

const SkillsGrid = () => {
  const skills = useMemo(() => [
    { icon: <FaPython />, name: 'Python' },
    { icon: <FaDatabase />, name: 'SQL' },
    { icon: <FaKeyboard />, name: 'NLP' },
    { icon: <FaCode />, name: 'Machine Learning' },
